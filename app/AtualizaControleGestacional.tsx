...
export default function AtualizaControleGestacional() {
    ...
    async function salvarControle() {
        try {
            ...
            if (dataMenstruacao.trim() !== '') data.dataUltimaMenstruacao = dataMenstruacao;
            if (dataConsulta.trim() !== '') data.dataConsulta = dataConsulta;
            if (idadeGestacional.trim() !== '') data.idadeGestacionalConsulta = idadeGestacional;
    ...
    const atualizarBebe = (index: number, campo: 'peso' | 'comprimento', valor: string) => {
                    ...
                    {step === 1 && (
                        <>
                            ...
                            {bebes.map((bebe, index) => (
                                <View key={index}>
                                    <Text style={styles.subTitle}>Informações do {bebe.nome}:</Text>
