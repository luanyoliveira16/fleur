...
import { Alert, Image, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard, } from "react-native";
...
export default function CadastrarGestante() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const nomesBebes =
        tipoGestacaoLower === "gemelar"
          ? bebes.filter(b => b.trim() !== "")
          : [bebes[0]].filter(b => b.trim() !== ""); 
...
const styles = StyleSheet.create({
  ...
  radioCircle: { height: 20, width: 20, borderRadius: 10, borderWidth: 2, borderColor: "#000", alignItems: "center", justifyContent: "center", marginRight: 8 },
